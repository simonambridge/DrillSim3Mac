...
Begin
  ...
  Begin
    ...
    JetVelUoM.Caption:='fpm?';
    ImpactForceUoM.Caption:='lbf';
    BitHPUoM.Caption:='HP';
    BitEffUoM.Caption:='%';
    TotalHPUoM.Caption:='HP';

    AnnularBHPUoM.Caption:=UoMLabel[3];      { pressure psi or KPa }
    AverageHHDUoM.Caption:=UoMLabel[3];      { pressure psi or KPa }
    PipeHHDUoM.Caption:=UoMLabel[3];         { pressure psi or KPa }
    AnnulusHHDUoM.Caption:=UoMLabel[3];      { pressure psi or KPa }
