...
Begin
  ...
  Begin
    ...
    DrillSim.WOH.Caption:=FloatToStrF(Round2(WOH/UoMConverter[7],2), ffNumber, 8, 2); { API -> displayed } ;
    DrillSim.StringWt.Caption:=FloatToStrF(Round2(StrWt/UoMConverter[7],2), ffNumber, 8, 2); { API -> displayed } ;
